...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.batch_button = QtGui.QPushButton(self.frame_5)
        self.batch_button.setObjectName(_fromUtf8("batch_button"))
        self.gridLayout_2.addWidget(self.batch_button, 4, 1, 1, 1)
        ...
        self.radioButton = QtGui.QRadioButton(self.frame_5)
        self.radioButton.setObjectName(_fromUtf8("radioButton"))
        self.gridLayout_2.addWidget(self.radioButton, 1, 0, 1, 1)
        self.radioButton_2 = QtGui.QRadioButton(self.frame_5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "Single File", None))
        self.radioButton_2.setText(_translate("MainWindow", "Batch Process", None))
